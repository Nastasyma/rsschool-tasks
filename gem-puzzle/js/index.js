...
function setGame8() {
  ...
  canvas.addEventListener("click", function(e) {
    ...
    //console.log(arrayNums8);
    if (arrayNums8 === [1, 2, 3, 4, 5, 6, 7, 8, 0]) {
    alert ("Win!!");
    }
  });
}
function setGame15() {
  ...
  canvas.addEventListener("click", function(e) {
    ...
    for (let i = 0; i<=15; i++) {
      ...
      //console.log(arrayNums15);
    if (arrayNums15 === [1, 2, 3, 4, 5, 6, 7, 8, 0]) {
    alert ("Win!!");
    }
  });
...
function setGame3() {
  ...
  const drawCell = function(position, value) {
    ...
    else if (position === 2) { drawBox(0, 100, value); }
    else if (position === 3) { drawBox(100, 100, value); }
  }
  ...
  canvas.addEventListener("click", function(e) {
    ...
    //console.log(arrayNums3);
    if (arrayNums3[0] === 1 && arrayNums3[1] === 2 && arrayNums3[2] === 3 && arrayNums3[3] === 0) {
